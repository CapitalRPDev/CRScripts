...
AddEventHandler('cd_garage:UpdateGarageType', function(garage_type, all_plates)
    if garage_type == 'car' or garage_type == 'boat' or garage_type == 'air' then
        ...
        DB.exec('UPDATE '..FW.vehicle_table..' SET garage_type="'..garage_type..'", garage_id="'..default_garage_id..'" WHERE plate="'..all_plates.trimmed..'" or plate="'..all_plates.with_spaces..'" or plate="'..all_plates.mixed..'"')
    else
