LocalesTable = {
    ['EN'] = { --english
        ...
        ['vehicle_onstreets'] = 'This vehicle is already in use. A waypoint has been set.',
        ['vehicle_onstreets_destroyed'] = 'This vehicle is already in use but has been destroyed. A waypoint has been set.',
        ...
        ['chatsuggestion_givekey'] = 'Give a player keys to the closest vehicle',
    ...
    ['CZ'] = { --Czech
        ...
        ['logs_exploit_message'] = '@everyone %s se pokusil vytvořit vozidlo [%s] s hashem: %s. Jeho původní vozidlo: %s\n```\nIdentifikátor: %s\n```',
        ...
        --client
        ['property'] = 'Majetek',
        ['notif_exitgarage'] = '<b>Garáž</b></p>Stiskni [E] pro opuštění garáže',
        ...
        ['dont_own_veh'] = 'Nevlastníš toto vozidlo',
        ['miles_check_miles'] = 'MÍLE : %s',
        ['miles_check_kilometers'] = 'KOLOMETRY : %s',
        ['maxhealth_check'] = 'MAXIMÁLNÍ ZDRAVÍ : %s',
        ['impound'] = 'Odtah',
        ['open_impound'] = 'Stiskněte [E] pro otevření odtahového parkovištně.',
        ['no_permissions_impounding'] = 'Nemáš oprávnění zabavovat vozidla.',
        ...
        ['chatsuggestion_mileage'] = 'Zkontrolujte počet najetých kilometrů svého vozidla',
        ['chatsuggestion_impound'] = 'Odtáhnout vozidlo',
        ['chatsuggestion_transferveh'] = 'Převést vozidlo na jiného hráče',
        ['chatsuggestion_vehicle_add'] = 'Pouze pro zaměstnance – Přidat vozidlo do garáže hráče',
        ['chatsuggestion_vehicle_delete'] = 'Pouze pro zaměstnance – Odstranit vozidlo z garáže hráče',
        ['chatsuggestion_vehicle_plate'] = 'Pouze pro zaměstnance – Změnit poznávací značku vozidla',
        ['chatsuggestion_vehicle_keys'] = 'Pouze pro zaměstnance – Dejte si klíče od tohoto vozidla',
        ['chatsuggestion_garagespace'] = 'Pouze pro prodejce aut – Prodejte místo v garáži jinému hráči',
        ['chatsuggestion_garagespace_check'] = 'Zkontrolujte, kolik míst v garáži máte',
        ['chatsuggestion_closeui'] = 'Tento příkaz násilně zavře všechna menu a uživatelská rozhraní. - Tento příkaz můžete také použít v F8, pouze bez /',
        ['chatsuggestion_fakeplate'] = 'Odstranit falešnou poznávací značku.',
        ['chatsuggestion_privategarage_1'] = 'Pouze nemovitosti – Prodejte soukromou garáž hráči',
        ['chatsuggestion_privategarage_2'] = 'typ garáže',
        ['chatsuggestion_privategarage_3'] = 'Zadejte typ garáže pro tuto garáž (auto/loď/letadlo)',
        ['chatsuggestion_playerid_1'] = 'ID hráče',
        ['chatsuggestion_playerid_2'] = 'Zadejte ID hráče',
        ['chatsuggestion_garagename_1'] = 'Název garáže',
        ['chatsuggestion_garagename_2'] = 'Název této soukromé garáže',
        ['chatsuggestion_vehiclelock'] = 'Zamknout vozidlo',
        ['chatsuggestion_showkey'] = 'Zobrazení předání nebo odebrání klíčů od vozidla',
        ['chatsuggestion_givekey'] = 'Dát hráči klíče od tohoto vozidla.',
        ...
        ['chatsuggestion_lockpick'] = 'Odemkněte nejbližší vozidlo',
        ['lock_cooldown'] = 'Zámek vozidla má 1 sekundový cooldown.',
        ['return_vehicle_disabled'] = 'Funkce vrácení vozidla byla deaktivována.',
        ['chatsuggestion_privategarage_4'] = 'Pouze nemovitosti – Smazání soukromé garáže hráče',
        ['chatsuggestion_privategarage_5'] = 'Název garáže',
        ['chatsuggestion_privategarage_6'] = 'Zadejte název garáže, jak je uveden v nabídce pauzy.',
        ['privategarage_deleted'] = 'Soukromá garáž byla odstraněna',
        ['privategarage_not_found'] = 'Soukromá garáž nebyla nalezena',
        ['vehicle_not_locked'] = 'Toto vozidlo není zamčené.',
        ['lockpicking_failed'] = 'Odemykání se nezdařilo',
        ['cant_transfergarage_same_garage'] = 'Nelze převést do stejné garáže',
        ['unknown'] = 'Neznámé',
        ['impound_vehicle_not_empty'] = 'Nemůžeš odtáhnout vozidlo kde někdo sedí',
        ['cant_lockpick_have_keys'] = 'Nemůžete odemknout vozidlo, ke kterému již máte klíče.',
    },
